// Note: filename follows the requested name "leage_service.dart"
...
class LeageService {
  ...
  /// name, season, logoUrl, MatchesSystem, TeamsPairing, NumberOfTeams,
  /// NumberOfGroups, MatchDays, groupNames
  ...
  /// Optional helper: check if a league exists
